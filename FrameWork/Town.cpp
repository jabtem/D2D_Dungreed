...
void Town::Update(double frame)
{
	...
	town.treeX = camera.Get_CameraX()*0.4f;
	...
	//else if (groundX < GroundLength && groundX >= GroundLength * 2 && gMoveCnt == 0)
	//{
	//	gX += GroundLength;
	//}

	//skyY = (character.m_H - 400) / 5;
}
...
void Town::Draw()
{
	...
	SetLine(town_Line[3], 6254 + floorXpos, 1235 , 6254 + 566 + floorXpos, 1235 - 566 );
	...
	SetLine(town_Line[4], 2372 + floorXpos, 1230 , 2372 + 68 + floorXpos, 1230 );
	SetLine(town_Line[5], 2778 + floorXpos, 1225 , 2778 + 138 + floorXpos, 1225 );
	SetLine(town_Line[6], 5618 + floorXpos, 1225 , 5618 + 135 + floorXpos, 1225 );
	SetLine(town_Line[7], 6179 + floorXpos, 1230 , 6179 + 63 + floorXpos, 1230 );
	SetLine(town_Line[11], 64 + floorXpos, 674, 64 + 1753 + floorXpos, 674);
	SetLine(town_Line[12], 3331 + floorXpos, 814, 3331 + 1889 + floorXpos, 814);
	SetLine(town_Line[13], 6807 + floorXpos, 674, 6807 + 1751 + floorXpos, 674);


	Town_Floor.Render(floorXpos - camera.Get_CameraX(), -cameraY, 0, 1, 1);

	//바닥
	SetRect(&town_RecT[0], 0+ groundX, 478- floorYpos, GroundLength+ groundX, 573- floorYpos);
	...
	SetLine(town_Line[8], 1000 , 300 - floorYpos, 1000 + 168, 300 - floorYpos);
	...
	SetLine(town_Line[9], 800, 200 - floorYpos, 800 + 168, 200 - floorYpos);
	...
	SetLine(town_Line[10], 1000, 100 - floorYpos, 1000 + 168, 100 - floorYpos);
